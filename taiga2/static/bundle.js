...
/***/ function(module, exports, __webpack_require__) {
	...
	var FolderView_1 = __webpack_require__(67);
	var LeftNav_1 = __webpack_require__(68);
	...
	var Home = React.createClass({
	    render: function () {
	        return (React.createElement("div", null, React.createElement("p", null, React.createElement(react_router_1.Link, {to: "/app/folder/1"}, "folder")), React.createElement("p", null, React.createElement(react_router_1.Link, {to: "/app/dataset/2"}, "dataset"))));
	    }
	});
	var DatasetView = React.createClass({
	    render: function () {
	        return (React.createElement("div", null, React.createElement("h2", null, "Dataset: ", this.props.params.datasetId), React.createElement(DatasetDetails, null)));
	    }
	});
	var DataFileTable = React.createClass({
	    render: function () {
	        var rows = [];
	        return (React.createElement("table", null, React.createElement("thead", null, React.createElement("tr", null, React.createElement("th", null, "Name"), React.createElement("th", null, "Summary"))), React.createElement("tbody", null, rows)));
	    }
	});
	...
	var DatasetDetails = React.createClass({
	    render: function () {
	        return (React.createElement("div", null, React.createElement(LeftNav_1.LeftNav, null), React.createElement("h1", null, "Name"), React.createElement(EditButton, null), "Created by, Created time" + ' ' + "Versions..." + ' ' + "Description", React.createElement(EditButton, null), React.createElement(DataFileTable, null)));
	    }
	});
	...
	var ProvenanceView = React.createClass({
	    render: function () {
	        var rows = [];
	...
	ReactDOM.render((React.createElement(react_router_1.Router, {history: react_router_1.browserHistory}, React.createElement(react_router_1.Route, {path: "/app", component: App}, React.createElement(react_router_1.IndexRoute, {component: Home}), React.createElement(react_router_1.Route, {path: "dataset/:datasetId", component: DatasetView}, React.createElement(react_router_1.IndexRoute, {component: DatasetDetails}), React.createElement(react_router_1.Route, {path: "activity", component: ActivityView}), React.createElement(react_router_1.Route, {path: "provenance", component: ProvenanceView})), React.createElement(react_router_1.Route, {path: "folder/:folderId", component: FolderView_1.FolderView})), React.createElement(react_router_1.Route, {path: "*", component: NoMatch}))), document.getElementById('root'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LeftNav_1 = __webpack_require__(68);
	var react_router_1 = __webpack_require__(3);
	var Folder = __webpack_require__(69);
	var static_folder = {
	    id: "x",
	    name: "Child Dir",
	...
	var FolderView = (function (_super) {
	    ...
	    FolderView.prototype.render = function () {
	        ...
	        var parent_links = folder.parents.map(function (p) {
	        ...
	        var folder_rows = subfolders.map(function (e) {
	            return React.createElement("tr", null, React.createElement("td", null, React.createElement("input", {type: "checkbox"})), React.createElement("td", null, React.createElement(react_router_1.Link, {to: "/app/folder/" + e.id}, e.name)), React.createElement("td", null, e.creationDate), React.createElement("td", null, e.creator.name));
	        });
	        var other_rows = others.map(function (e) {
	            var link;
	            ...
	            return React.createElement("tr", null, React.createElement("td", null, React.createElement("input", {type: "checkbox"})), React.createElement("td", null, link), React.createElement("td", null, e.creationDate), React.createElement("td", null, e.creator.name));
	        });
	        console.log(this.props.params);
	        return (React.createElement("div", null, React.createElement(LeftNav_1.LeftNav, null), React.createElement("h1", null, folder.name), React.createElement("p", null, "Parents: ", parent_links), React.createElement("table", null, React.createElement("thead", null, React.createElement("tr", null, React.createElement("th", null), React.createElement("th", null, "Name"), React.createElement("th", null, "Date"), React.createElement("th", null, "Creator"))), React.createElement("tbody", null, folder_rows)), React.createElement("h2", null, "Datasets"), React.createElement("table", null, React.createElement("thead", null, React.createElement("tr", null, React.createElement("th", null), React.createElement("th", null, "Name"), React.createElement("th", null, "Date"), React.createElement("th", null, "Creator"))), React.createElement("tbody", null, other_rows))));
	    };
	    return FolderView;
	}(React.Component));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var LeftNav = (function (_super) {
	    __extends(LeftNav, _super);
	    function LeftNav() {
	        _super.apply(this, arguments);
	    }
	    LeftNav.prototype.render = function () {
	        return React.createElement("div", null, "LeftNav");
	    };
	    return LeftNav;
	}(React.Component));
...
/***/ function(module, exports) {
	...
	(function (FolderEntries) {
	    (function (TypeEnum) {
	        ...
	        TypeEnum[TypeEnum["DatasetVersion"] = 'datasetVersion'] = "DatasetVersion";
