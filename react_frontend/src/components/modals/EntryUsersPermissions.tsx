...
export class EntryUsersPermissions extends React.Component<
  EntryUsersPermissionsProps,
  EntryUsersPermissionsState
> {
  componentWillMount() {
    this.setState({
      accessLogs: [],
        ...
        <div className="modal-content">
          ...
          <div className="modal-body">
            <BootstrapTable
              ...
              options={options}
            >
              <TableHeaderColumn dataField="user_id" isKey hidden>
                User Id
              </TableHeaderColumn>
