...
export class CreateDatasetDialog extends React.Component<
...
export class CreateVersionDialog extends React.Component<
...
> {
  ...
  constructor(props: UploadDialogProps) {
    ...
    this.controller = new UploadController(files, (files: any) =>
          ...
          <div className="row">
            ...
            <div className="col-md-5">
              ...
              <div>
                ...
                <code>taiga-892@cds-logging.iam.gserviceaccount.com</code> must
                have <code>storage.buckets.get</code> access to the bucket.
              </div>
              <UploadTable
